...
const StudentBatchFormScreen = ({route, navigation}) => {
  ...
  const [showBatchStartDatePicker, setShowBatchStartDatePicker] =
    useState(false);
    ...
    if (IsFormValid()) {
      try {
        if (studentBatch.StudentBatchId !== 0) {
          ...
          httpPost(
            `StudentBatch/IsExistsRegistration?RegistrationNumber=${studentBatch.RegistrationNumber}`,
          )
            .then(response => {
        ...
        <ScrollView
          ...
          <View
            ...
            <TextInput
              ...
              value={
                studentBatch.DateOfJoin === '' ||
                studentBatch.DateOfJoin === null
                  ? 'Select Date Of Join'
                  : getFormattedDate(studentBatch.DateOfJoin)
              }
          ...
          <TextInput
            ...
            onChangeText={value =>
              setStudentBatch({...studentBatch, RegistrationNumber: value})
            }
          ...
          <TouchableOpacity
            ...
            <Text
              ...
              {studentBatch.StudentBatchId !== 0 ? 'Save' : 'Add'}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
