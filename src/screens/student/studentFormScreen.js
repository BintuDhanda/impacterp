    ...
    <View style={{flex: 1}}>
      <View
        ...
        <ScrollView
          ...
          <Image
            source={
              formData.StudentImage == null || formData.StudentImage == ''
                ? require('../../icons/user.png')
                : {uri: News_URL + formData.StudentImage}
            }
            style={{
              width: 100,
              height: 100,
          ...
          <TextInput
            ...
            onChangeText={value =>
              setFormData({...formData, StudentHeight: value})
            }
          ...
          <TextInput
            ...
            onChangeText={value =>
              setFormData({...formData, StudentWeight: value})
            }
