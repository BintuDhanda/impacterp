      ...
      <View
        ...
        <View style={{flexDirection: 'row'}}>
          <TouchableOpacity
            ...
            onPress={() => handleEditAddressType(item.addressTypeId)}>
            <Icon
              name="pencil"
              size={20}
              color={'#5a67f2'}
          ...
          <TouchableOpacity
            onPress={() => {
              DeleteAddressTypeIdConfirm(item.addressTypeId);
              setShowDelete(true);
            }}>
            <Icon
              name="trash"
          ...
          <View
            ...
            <View
              ...
              <TextInput
                ...
                onChangeText={text =>
                  setAddressType({...addressType, AddressTypeName: text})
                }
              />
              ...
              <TouchableOpacity
                ...
                <Text
                  ...
                  {addressType.AddressTypeId !== 0 ? 'Save' : 'Add'}
                </Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
