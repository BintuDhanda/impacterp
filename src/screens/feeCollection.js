...
const StudentBatchFeesScreen = ({navigation}) => {
  ...
  const [studentBatchFeesDeposit, setStudentBatchFeesDeposit] = useState({
    StudentBatchFeesId: 0,
    RegistrationNumber: '',
    Particulars: '',
    Deposit: 0,
    Refund: 0,
  ...
  const [studentBatchFeesRefund, setStudentBatchFeesRefund] = useState({
    StudentBatchFeesId: 0,
    RegistrationNumber: '',
    Particulars: '',
    Deposit: 0,
  ...
  const handleHistory = () => {
    ...
    if (registrationNumber.RegistrationNumber === '') {
      ...
      navigation.navigate('StudentBatchFeesHistoryScreen', {
  ...
  const handleSaveStudentBatchFeesDeposit = () => {
    ...
    httpPost('StudentBatchFees/RegistrationIsExists', filter)
      .then(response => {
        if (response.data === false) {
          ...
          httpPost('StudentBatchFees/post', studentBatchFeesDeposit).then(
            response => {
              if (response.status === 200) {
                ...
                Alert.alert(
                  'Sucess',
                  'StudentBatchFees Deposit is Added Successfully',
                );
                setLoading(true);
                const filter = {
                  RegistrationNumber: registrationNumber.RegistrationNumber,
                ...
                httpPost(
                  'StudentBatchFees/getStudentBatchFeesByRegistrationNumber',
                  filter,
                )
                  .then(response => {
                    setLoading(false);
                  ...
                  .catch(error => {
                    setLoading(false);
                    console.error(
                      'Add Deposit Get Student Batch Fees By Registration Number error',
                      error,
                    );
                    Toast.show({
                      type: 'error',
    ...
    httpPost('StudentBatchFees/RegistrationIsExists', filter)
      .then(response => {
        if (response.data === false) {
          ...
          httpPost('StudentBatchFees/post', studentBatchFeesRefund).then(
            response => {
              if (response.status === 200) {
                setStudentBatchFeesList([]);
                setSkip(0);
                Alert.alert(
                  'Sucess',
                  'StudentBatchFees Refund is Added Successfully',
                );
                setLoading(true);
                const filter = {
                  RegistrationNumber: registrationNumber.RegistrationNumber,
                ...
                httpPost(
                  ...
                  .catch(error => {
                    setLoading(false);
                    console.error(
                      'Add Refund Get Student Batch Fees By Registration Number error',
                      error,
                    );
                    Toast.show({
                      type: 'error',
  ...
  const onSuccess = e => {
    setStudentBatchFeesDeposit({
      ...studentBatchFeesDeposit,
      RegistrationNumber: e.data,
    });
    setStudentBatchFeesRefund({
      ...studentBatchFeesRefund,
      RegistrationNumber: e.data,
    });
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      <Text
                        ...
                        {studentBatchFeesDeposit.StudentBatchFeesId === 0
                          ? 'Add'
                          : 'Save'}
                      </Text>
                    </TouchableOpacity>
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      <Text
                        ...
                        {studentBatchFeesRefund.StudentBatchFeesId === 0
                          ? 'Add'
                          : 'Save'}
                      </Text>
                    </TouchableOpacity>
