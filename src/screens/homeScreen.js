    ...
    <ScrollView
      ...
      <View style={styles.container}>
        <View style={styles.cardContainer}>
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('UserScreen')}>
            <Icon
              name="users"
              size={50}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('RolesScreen')}>
            <Icon
              name="key"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('StudentDetailsScreen')}>
            <Icon
              name="graduation-cap"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('QualificationScreen')}>
            <Icon
              name="certificate"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('CountryScreen')}>
            <Icon
              name="map-marker"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('CourseCategoryScreen')}>
            <Icon
              name="book"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('AddressTypeScreen')}>
            <Icon
              name="map"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('EnterAccountScreen')}>
            <Icon
              name="bank"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('StudentBatchFeesScreen')}>
            <Icon
              name="money"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('StudentTokenFeesScreen')}>
            <Icon
              name="credit-card"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('AttendanceScreen')}>
            <Icon
              name="calendar"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('NewsScreen')}>
            <Icon
              name="newspaper-o"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('SendNotificationScreen')}>
            <Icon
              name="bell"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('IdentityTypeScreen')}>
            <Icon
              name="id-badge"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('SliderScreen')}>
            <Icon
              name="sliders"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('Hostels')}>
            <Icon
              name="building"
              size={50}
              color={Colors.primary}
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => handleIconPress('StudentHostelRoomBad')}>
            <Icon
              name="building"
              size={50}
              color={Colors.primary}
        ...
        <View
          style={{justifyContent: 'center', marginTop: 30, marginBottom: 20}}>
