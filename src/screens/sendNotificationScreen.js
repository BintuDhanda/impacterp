...
const SendNotificationScreen = () => {
  ...
  const handleSendAll = () => {
    httpPost('User/UserNotification', {
      Body: body,
      Title: title,
      SendToId: SendToId,
      SendToType: 'All',
      ...
      <View style={{flex: 1}}>
        <Animated.View
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              setShowSendCourseCategory(true);
            }}>
            <Text
              style={{
                color: Colors.background,
